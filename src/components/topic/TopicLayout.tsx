...
export function TopicLayout({
  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-0 py-6">
      ...
      {overview ? (
        <section className="space-y-3">
          ...
          <div className="text-sm leading-7 text-slate-600">{overview}</div>
        </section>
      ) : null}
      ...
      {process ? (
        <section className="space-y-3">
          ...
          <div className="text-sm leading-7 text-slate-600">{process}</div>
        </section>
      ) : null}

      <div className={`grid gap-8 ${explanation ? "xl:grid-cols-[minmax(0,1.4fr)_320px]" : ""}`}>
        <div className="space-y-8">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-slate-900">{visualizationTitle}</h2>
        ...
        {explanation ? (
          <div className="space-y-6 xl:sticky xl:top-20 xl:self-start">
            <section className="space-y-3 border-l border-slate-200 pl-6">
